...
const wpNumberInput = document.getElementById("wpNumber"), urlAPIset = `${sessionStorage.urlEP}/api/Generics/v1/SetContactNumber?oID=1&number=`; updateWP.addEventListener("click", (function () { const e = wpNumberInput.value; fetch(sessionStorage.urlEP + "/api/Generics/v1/SetContactNumber?oID=1", { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(e) }).then((e => { if (e.ok) return e.json(); throw new Error("Algo salió mal!") })).then((e => { Swal.fire({ icon: "success", title: "Actualizado!", text: "El número de Whatsapp ha sido actualizado", confirmButtonColor: "#008dc9" }) })).catch((e => { Swal.fire({ icon: "error", title: "Oops...", text: e.message, confirmButtonColor: "#008dc9" }) })) }));
